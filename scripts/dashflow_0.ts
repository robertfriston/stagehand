...
async function run() {
  ...
  // Use frameLocator for the main login/signup iframe
  const frame = page.frameLocator('iframe[title="React App Login"]');
  ...
  for (let i = 0; i < 2; i++) {
    ...
    await frame.getByTestId("signin").click();

    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("firstNamesString").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("firstNamesString").fill(userCredentials.firstname);
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("lastNameString").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("lastNameString").fill(userCredentials.lastname);
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("email").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("email").fill(userCredentials.email);
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("username").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("username").fill(userCredentials.username);
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("password").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("password").fill(userCredentials.password);
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("agree").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByRole("button", { name: "Sign Up" }).click();
    await page.waitForTimeout(defaultTimeout);
    ...
    try {
      await frame.getByTestId("login").click(); // Removed timeout
    ...
    await frame.getByTestId("username").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("username").fill(userCredentials.email); // Assuming email is used for login username
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("password").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("password").fill(userCredentials.password);
    ...
    await frame.getByTestId("agree").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("seek").click(); // Login button
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("profile").getByText("Profile").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("firstNamesString").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("firstNamesString").click(); // Double click? Match helloDashboard
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("firstNamesString").press("ArrowRight");
    await page.waitForTimeout(defaultTimeout);
    ...
    await frame.getByTestId("firstNamesString").fill(nameWithTimestamp);
    await page.waitForTimeout(defaultTimeout);
    ...
    await frame.getByTestId("profile").getByText("Profile").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("delete_account").click();
    await page.waitForTimeout(defaultTimeout);
    ...
    await frame.getByTestId("username").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("username").fill(userCredentials.email);
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("password").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("password").fill(userCredentials.password);
    ...
    await frame.getByTestId("agree").click();
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("seek").click();
    await page.waitForTimeout(defaultTimeout);
    ...
    await frame.getByText("Start A Chat").click(); // Removed timeout and try/catch
    await page.waitForTimeout(defaultTimeout);
    await frame.getByTestId("RNE__Input__text-input").click();
    await page.waitForTimeout(defaultTimeout);
    await frame
    ...
    await page.waitForTimeout(5000);
    await frame.getByText("Close Your Agent").click();
